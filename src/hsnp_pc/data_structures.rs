...
pub struct UniversalParams<E: PairingEngine> {
    ...
    pub powers_of_h: BTreeMap<usize, E::G2Affine>,
...
impl<E: PairingEngine> CanonicalDeserialize for UniversalParams<E> {
    fn deserialize<R: Read>(mut reader: R) -> Result<Self, SerializationError> {
        ...
        let powers_of_h = BTreeMap::<usize, E::G2Affine>::deserialize(&mut reader)?;
    ...
    fn deserialize_unchecked<R: Read>(mut reader: R) -> Result<Self, SerializationError> {
        ...
        let powers_of_h = BTreeMap::<usize, E::G2Affine>::deserialize_unchecked(&mut reader)?;
...
pub struct VerifierKey<E: PairingEngine> {
    ...
    /// \beta times the above generator for making a commitment hiding.
    pub gamma_beta_g: E::G1Affine,
    /// The generator of G2.
    pub h: E::G2Affine,
    /// \beta times the above generator of G2.
    pub beta_h: E::G2Affine,
...
impl<E: PairingEngine> CanonicalSerialize for VerifierKey<E> {
    fn serialize<W: Write>(&self, mut writer: W) -> Result<(), SerializationError> {
        ...
        self.gamma_beta_g.serialize(&mut writer)?;
        self.h.serialize(&mut writer)?;
        self.beta_h.serialize(&mut writer)
    }
    ...
    fn serialized_size(&self) -> usize {
        self.g.serialized_size()
            ...
            + self.gamma_beta_g.serialized_size()
            + self.h.serialized_size()
            + self.beta_h.serialized_size()
    }
    ...
    fn serialize_uncompressed<W: Write>(&self, mut writer: W) -> Result<(), SerializationError> {
        ...
        self.gamma_beta_g.serialize_uncompressed(&mut writer)?;
        self.h.serialize_uncompressed(&mut writer)?;
        self.beta_h.serialize_uncompressed(&mut writer)
    }
    ...
    fn serialize_unchecked<W: Write>(&self, mut writer: W) -> Result<(), SerializationError> {
        ...
        self.gamma_beta_g.serialize_unchecked(&mut writer)?;
        self.h.serialize_unchecked(&mut writer)?;
        self.beta_h.serialize_unchecked(&mut writer)
    }
    ...
    fn uncompressed_size(&self) -> usize {
        self.g.uncompressed_size()
            ...
            //+ self.gamma_beta_g.uncompressed_size()
            + self.h.uncompressed_size()
            + self.beta_h.uncompressed_size()
    }
}
...
impl<E: PairingEngine> CanonicalDeserialize for VerifierKey<E> {
    fn deserialize<R: Read>(mut reader: R) -> Result<Self, SerializationError> {
        ...
        let gamma_beta_g = E::G1Affine::deserialize(&mut reader)?;
        let h = E::G2Affine::deserialize(&mut reader)?;
        let beta_h = E::G2Affine::deserialize(&mut reader)?;
    ...
    fn deserialize_uncompressed<R: Read>(mut reader: R) -> Result<Self, SerializationError> {
        ...
        let gamma_beta_g = E::G1Affine::deserialize_uncompressed(&mut reader)?;
        let h = E::G2Affine::deserialize_uncompressed(&mut reader)?;
        let beta_h = E::G2Affine::deserialize_uncompressed(&mut reader)?;
    ...
    fn deserialize_unchecked<R: Read>(mut reader: R) -> Result<Self, SerializationError> {
        ...
        let gamma_beta_g = E::G1Affine::deserialize_unchecked(&mut reader)?;
        let h = E::G2Affine::deserialize_unchecked(&mut reader)?;
        let beta_h = E::G2Affine::deserialize_unchecked(&mut reader)?;
...
impl<E: PairingEngine> ToBytes for VerifierKey<E> {
    ...
    fn write<W: Write>(&self, mut writer: W) -> ark_std::io::Result<()> {
        ...
        self.gamma_beta_g.write(&mut writer)?;
    ...
    E::G2Affine: ToConstraintField<<E::Fq as Field>::BasePrimeField>,
{
    fn to_field_elements(&self) -> Option<Vec<<E::Fq as Field>::BasePrimeField>> {
        ...
        res.extend_from_slice(&self.gamma_beta_g.to_field_elements().unwrap());
...
pub struct ComEvProof<E: PairingEngine> {
    ...
    pub rho: E::Fr,
    /// This is the first component of the sigma prototol response
    pub sigma: E::Fr,
    /// This is the second component of the sigma prototol response
    pub tau: E::Fr,
}
...
/// `PoKProof` is a ZKPoK of the opening of a commitment 
/// to a degree0 polynomial with degree-0 blinding polynomial
#[derive(Derivative, CanonicalSerialize, CanonicalDeserialize)]
#[derivative(
    Default(bound = ""),
    Hash(bound = ""),
...
pub struct PoKProof<E: PairingEngine> {
...
impl<E: PairingEngine> ToBytes for PoKProof<E> {
    #[inline]
    fn write<W: Write>(&self, mut writer: W) -> ark_std::io::Result<()> {
        self.com1.write(&mut writer)?;
        self.sigma.write(&mut writer)?;
        self.tau.write(&mut writer)
    }
}
...
/// `SpecializedVerifierKey` is a verification key specialized for CPsvec with parameter t
#[derive(Derivative, CanonicalSerialize, CanonicalDeserialize)]
#[derivative(
    Clone(bound = ""),
    Debug(bound = ""),
)]
pub struct SpecializedVerifierKey<E: PairingEngine> {
    /// This is a verification key
    pub vk: VerifierKey<E>,
    /// This is a commitment to the vanishing polynomial in the domain_t
    pub com_zt: E::G2Affine,
}

impl<E: PairingEngine> ToBytes for SpecializedVerifierKey<E> {
    #[inline]
    fn write<W: Write>(&self, mut writer: W) -> ark_std::io::Result<()> {
